  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "udacity-hovered":
          "0 0 8px 0 rgb(17 22 26 / 6%), 0 4px 16px 0 rgb(17 22 26 / 8%), 0 8px 12px 0 rgb(17 22 26 / 6%), 0 16px 24px 0 rgb(17 22 26 / 4%);",
        "udacity-standard":
          "0 4px 8px 0 rgb(17 22 26 / 16%), 0 4px 8px 0 rgb(17 22 26 / 8%), 0 8px 16px 0 rgb(17 22 26 / 4%)",
      },
      backgroundImage: {
        courseCard:
          "linear-gradient(180deg,rgba(3,7,25,.57),transparent),linear-gradient(315deg,#02ccba,#02b3e4)",
      },
      animation: {
