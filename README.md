...
So hey there! a little summary and guide of using this project!
...
*INSTALLING*
    ...
    3. run "nm run-script server-start" in the command promot to start the back-end server. you should get the output "Listening to ort 5000"
...
### `npm run server-start`
    ...
    runs the back-end server on port 5000
### `npm start`
